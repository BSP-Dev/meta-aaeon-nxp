...
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-aaeon-nxp/meta-parsec\"" >> $BUILD_DIR/conf/bblayers.conf
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-aaeon-nxp/meta-tpm\"" >> $BUILD_DIR/conf/bblayers.conf
...
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-aaeon-nxp\"" >> conf/bblayers.conf
